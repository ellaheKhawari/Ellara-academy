...
const fa: Dictionary = {
  ...
  hero: {
    ...
    subtitle:
      "لینگووا شما را با بهترین اساتید در دوره‌های انگلیسی، چینی، کره‌ای، اسپانیایی و فارسی همراه می‌کند؛ دوره‌های ساختاریافته، جلسات زنده و پنلی که پیشرفت شما را دقیق نشان می‌دهد.",
    cta: "مشاهده دوره‌ها",
  ...
  charts: {
    ...
    subtitle: "نگاهی به رشد دانش‌آموزان لینگووا در یک ترم ۱۲ هفته‌ای معمولی.",
  ...
  faq: {
    ...
    q3: "آیا می‌توانم لینگووا را با منابع دیگر ترکیب کنم؟",
    a3: "بله. بسیاری از دانش‌آموزان جلسات زنده لینگووا را در کنار کتاب‌ها یا اپلیکیشن‌های خودشان استفاده می‌کنند.",
